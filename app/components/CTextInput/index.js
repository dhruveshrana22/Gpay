...
//   const { darkmode } = useSelector((state) => state.auth);
  ...
  return (
    <>
        ...
        >
          <>
            ...
            <TextInput
              ...
              placeholderTextColor={BaseColors.whiteSmoke}
              ...
              style={{
                ...
                minHeight: multiline && numberOfLines * 20,
                position: "relative",
      ...
      {showError ? (
        <Text style={[Typography.errorText, styles.errorTxt, { ...errStyle }]}>
          {errorText}
        </Text>
      ) : null}
    </>
